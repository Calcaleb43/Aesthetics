...
Your appointment has been moved to a new time.`,
  ...
  },
  {
    ...
    name: "Booking updated (auto)",
    description: "Client notice when an admin updates booking details. Change list is included automatically.",
    subject: "Updated — {{serviceTitle}}",
    body: `Hi {{name}},

Your booking was updated. Please review the changes below.`,
    status: "published",
    sortOrder: 31,
  },
  {
    slug: "appointment_updated_staff",
    name: "Booking update alert studio (auto)",
    description: "Studio/staff notice when a booking is updated.",
    subject: "Updated — {{name}} · {{serviceTitle}}",
    body: `A booking was updated by the studio.`,
    status: "published",
    sortOrder: 32,
  },
  {
