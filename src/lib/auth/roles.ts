...
export function navVisible(role: AdminRole, href: string) {
  ...
  if (href.startsWith("/admin/appointments") || href.startsWith("/admin/availability") || href.startsWith("/admin/payments")) {
  ...
  if (
    ...
    href.startsWith("/admin/email") ||
    href.startsWith("/admin/coupons") ||
    href.startsWith("/admin/packages")
  ) {
